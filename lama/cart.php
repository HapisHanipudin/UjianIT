                    ...
                    <td>
                      <div class="input-group mb-3 d-flex align-items-center quantity-container" style="max-width: 120px">
                        <div class="input-group-prepend">
                          <a href="php/minuscart.php?id=<?php echo $row['cart_id']; ?>" class="btn btn-outline-black decrease" type="button">&minus;</a>
                        </div>
                        <input type="text" class="form-control text-center quantity-amount" value="<?php echo $row['quantity']; ?>" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" />
                        <div class="input-group-append">
                          <a href="php/addtocart.php?id=<?php echo $row['prod_id']; ?>" class="btn btn-outline-black increase" type="button">&plus;</a>
                        </div>
                      </div>
                    </td>
                    <td>Rp<?php echo $row['price'] * $row['quantity']; ?></td>
                    <td><a href="php/removefromcart.php?id=<?php echo $row['cart_id']; ?>" class="btn btn-black btn-sm">X</a></td>
                  </tr>
